...
public class TemplateController {
    ...
    public String home(Model model){
        if(assignmentRepository.count() == 0) {
            ...
            assignments.add(new Assignment("JavaFX", "project called ContactsDesktop", true));
            ...
            assignments.add(new Assignment("(Optional) SQL Review", "Project name: PeopleWebDb", false));
            ...
            assignments.add(new Assignment("Scala Basics", "Fork HelloScala project", true));
